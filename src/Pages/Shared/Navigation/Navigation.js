      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar style={{ background: "#0a192f" }} position="fixed">
          <Toolbar>
            ...
            <Grid sx={{ display: { xs: "none", md: "block" } }}>
              <HashLink className="link link-nav" to="/home#home">
                Home
              </HashLink>
              <HashLink className="link link-nav" to="/home#aboutme">
                About Me
              </HashLink>
              <HashLink className="link link-nav" to="/home#projects">
                Projects
              </HashLink>
              <HashLink className="link link-nav" to="/home#contact">
                Contact
              </HashLink>
              <a
            ...
            >
              ...
              <CloseIcon
                className={classNames("close-icon", { closed: !opened })}
              />
            </IconButton>
          </Toolbar>
        </AppBar>
